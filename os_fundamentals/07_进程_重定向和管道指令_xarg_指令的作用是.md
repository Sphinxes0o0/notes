---
title: "07_进程_重定向和管道指令_xarg_指令的作用是"
...
今天老师带你认识了面试中经常被问到的 Linux 指令，还初步讲解了进程的概念，但关于 Linux 的进阶知识以及最最让人头疼的网络知识，我们无法在一篇文章内讲完。想要了解更多知识，深入到真实互联网项目中学习实战技巧，也可以点击此处，即可跳转至《Java 就业急训营》介绍页面。
