---
title: "10_Socket_编程_epoll_为什么用红黑树"
description: "不知道平时你做网络编程的时候有没有碰到过 Socket 对象？或者在配置代理的时候，有没有碰到配置 Socket 地址？当你看到服务端 Socket、客户端 Socket 等名词时，是否可以明确理解这些概念？"
---
...
思考题
思考题目：请你找一个 epoll 的 hello world 例子，并尝试理解它。